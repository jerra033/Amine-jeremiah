                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-8 col-md-offset-2">
                            <h1 class="brand-heading" style="color: black">waggie's</h1>
                            <p class="intro-text">
...
<br>
        <section class="menu-content">
            ...
            <h6> AC Fare: <?php echo ("Euro. " . $ac_price . "/km & Euro." . $ac_price_per_day . "/day"); ?></h6>
            <h6> Non-AC Fare: <?php echo ("Euro. " . $non_ac_price . "/km & Euro." . $non_ac_price_per_day . "/day"); ?></h6>
