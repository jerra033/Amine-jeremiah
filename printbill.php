    ...
    <div class="container">
        ...
        <div class="box">
            ...
            <div class="col-md-10" style="float: none; margin: 0 auto; ">
                ...
                <br>
                <h4> <strong>Fare:&nbsp;</strong>  euros. <?php 
            if($charge_type == "days"){
                    echo ($fare . "/day");
                } else {
                    echo ($fare . "/km");
            ...
            ?></h4>
                ...
                ?>
                <h4> <strong>Total Fine:</strong> <label class="text-danger"> euros. <?php echo $total_fine; ?>/- </label> for <?php echo $extra_days;?> extra days.</h4>
                <br>
                <?php } ?>
                <h4> <strong>Total Amount: </strong> euros. <?php echo $total_amount; ?>/-     </h4>
                <br>
            </div>
        </div>
...
<footer class="site-footer">
        <div class="container">
            ...
            <div class="row">
                <div class="col-sm-6">
                    <h5>© <?php echo date("Y"); ?> waggie's</h5>
                </div>
            </div>
        </div>
    </footer>
